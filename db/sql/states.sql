INSERT INTO state(code, name) values ('AA', 'Armed Forces - Americas');
INSERT INTO state(code, name) values ('AE', 'Armed Forces - Europe/Africa/Canada');
INSERT INTO state(code, name) values ('AK', 'Alaska');
INSERT INTO state(code, name) values ('AL', 'Alabama');
INSERT INTO state(code, name) values ('AP', 'Armed Forces - Pacific');
